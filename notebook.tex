...
\usepackage[a4paper,left=0.2in,right=0.2in,top=0.6in,bottom=0.2in]{geometry}
\usepackage{hyperref}
\usepackage{fancyhdr}
\usepackage{listings}
\usepackage{xcolor}
...
\pagestyle{fancy}
\fancyhead[L]{LalCheetah - IIT Kanpur}
\fancyhead[R]{\thepage}
\fancyfoot[C]{}
...
\title{\vspace{-4ex}\Large{LalCheetah - IIT Kanpur ICPC Team Notebook (2016-17)}}
\author{}
\date{}
